...
const EditProfile = ({
  ...
  const onSubmit = e => {
    e.preventDefault();
    createProfile(formData, history, true); // Last param is edit=true to see if its edit or creating
  };
...
)(withRouter(EditProfile)); // using withRouter to use history.push in action
